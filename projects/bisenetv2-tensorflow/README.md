...
> Local JMP workpiece experiments: see [人工 ISAT 标注训练复现记录](../../experiments/03_manual_segmentation/fdjyp3/reports/training_report.md) and [伪标签训练复现记录](../../experiments/02_initial_segmentation/fdjyp3/reports/training_report.md).
