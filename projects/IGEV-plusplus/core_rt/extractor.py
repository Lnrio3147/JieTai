...
class Feature(SubModule):
    def __init__(self):
        ...
        # The complete IGEV++ checkpoint loaded by the caller contains these
        # backbone parameters, so an additional ImageNet download is neither
        # necessary nor desirable for inference.
        pretrained = False
        ...
        self.bn1 = model.bn1
        # timm 0.5.4 exposed ``act1`` separately.  In timm >= 1.0 the same
        # ReLU6 lives inside BatchNormAct2d (``bn1``), so no extra activation
        # should be applied.
